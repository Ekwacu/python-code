...
def open_sst(file_path):
    ...
    ds1=ds.sel(lev=85000)
    SST=ds1.v.mean('time') 
        
    return SST
        
#open the files   
AA = open_sst("C:/Diabatic_data/WIND/uvwind_mon/vwind1_1982-2000.nc")
BB = open_sst("C:/Diabatic_data/WIND/uvwind_mon/vwind1_2001-2019.nc")
...
diff_sig = open_diff_sig('C:/Diabatic_data/WIND/uvwind_mon/vwind_pvalue_active_inactive_diff.nc')
...
Plot(1, 1, 1, diff, diff_sig, clevs, '(ms-1)', "v-component of wind mean difference between PHE Active and Inactive periods")

fig.savefig('C:/Diabatic_data/WIND/uvwind_mon/JRA55_vwind_sig_diff.png', bbox_inches='tight', pad_inches = 0.1, dpi=300)