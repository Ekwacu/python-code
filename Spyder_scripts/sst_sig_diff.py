...
def open_sst(file_path):
    ...
    SST=ds1.ws.mean('time') 
        
    return SST
        
#open the files   
AA = open_sst("C:/Diabatic_data/WIND/uvwind_mon/wspd_1982-2000.nc")
BB = open_sst("C:/Diabatic_data/WIND/uvwind_mon/wspd_2001-2019.nc")
...
diff_sig = open_diff_sig('C:/Diabatic_data/WIND/uvwind_mon/wspd_pvalue_active_inactive_diff.nc')
...
Plot(1, 1, 1, diff, diff_sig, clevs, '(ms-1)', "Wind Speed mean difference between PHE Active and Inactive Periods")

fig.savefig('C:/Diabatic_data/WIND/uvwind_mon/JRA55_wspd_sig_diff.png', bbox_inches='tight', pad_inches = 0.1)