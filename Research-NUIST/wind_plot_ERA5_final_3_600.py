...
#Read-in the files
ds1 = xr.open_dataset('D:/Folder_2023/Research/Africa_Research/Ronald_wind/600hpa/file1.nc')
ds2 = xr.open_dataset('D:/Folder_2023/Research/Africa_Research/Ronald_wind/600hpa/file2.nc')
ds3 = xr.open_dataset('D:/Folder_2023/Research/Africa_Research/Ronald_wind/600hpa/file3.nc')
ds4 = xr.open_dataset('D:/Folder_2023/Research/Africa_Research/Ronald_wind/600hpa/file4.nc')
ds5 = xr.open_dataset('D:/Folder_2023/Research/Africa_Research/Ronald_wind/600hpa/file5.nc')
...
plt.pcolormesh(wspd_son['longitude'], wspd_son['latitude'], wspd_son, cmap='nipy_spectral',
               vmin=0, vmax=15)
...
plt.ylim([-7, 1.2])
plt.title('SON')
plt.text(0.107, 0.33, 'ERA5 (600 hPa)', rotation='vertical',
         transform=plt.gcf().transFigure)

ax = plt.subplot(1,4,2, projection=ccrs.PlateCarree())
plt.pcolormesh(wspd_djf['longitude'], wspd_djf['latitude'], wspd_djf, cmap='nipy_spectral',
               vmin=0, vmax=15)
...
plt.pcolormesh(wspd_mam['longitude'], wspd_mam['latitude'], wspd_mam, cmap='nipy_spectral',
               vmin=0, vmax=15)
...
plot_jja = plt.pcolormesh(wspd_jja['longitude'], wspd_jja['latitude'], wspd_jja, cmap='nipy_spectral',
                          vmin=0, vmax=15)
